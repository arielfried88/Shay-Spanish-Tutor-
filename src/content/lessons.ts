...
export const LESSONS: Lesson[] = [
  ...
  { id: 'greetings_4', topicId: 'greetings', hebrewTitle: 'כתבי מה אומרים!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['greet_hola','greet_adios','greet_gracias','greet_si','greet_no'], xpReward: 35 },
  ...
  { id: 'animals_4', topicId: 'animals', hebrewTitle: 'כתבי את שם החיה!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['animal_perro','animal_gato','animal_pajaro','animal_pez','animal_vaca','animal_leon','animal_mono'], xpReward: 35 },
  ...
  { id: 'food_4', topicId: 'food', hebrewTitle: 'כתבי מה טעים!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['food_pan','food_leche','food_agua','food_pizza','food_helado','food_huevo','food_pollo'], xpReward: 35 },
  ...
  { id: 'school_4', topicId: 'school', hebrewTitle: 'כתבי מה יש בתיק!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['school_lapiz','school_libro','school_mesa','school_silla','school_papel'], xpReward: 35 },
  ...
  { id: 'actions_4', topicId: 'actions', hebrewTitle: 'כתבי את הפעולה!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['act_correr','act_saltar','act_bailar','act_cantar','act_comer','act_beber','act_jugar','act_leer'], xpReward: 35 },
  ...
  { id: 'sports_4', topicId: 'sports', hebrewTitle: 'כתבי איזה ספורט!', difficulty: 2, gameType: 'fill_in_blank', wordPool: ['sport_futbol','sport_tenis','sport_gimnasia','sport_ciclismo','sport_voleibol'], xpReward: 35 },
]
